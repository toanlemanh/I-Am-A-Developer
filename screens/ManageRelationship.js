...
export default function ManageRelationship({ route, navigation }) {
  ...
  const handleActionClick = (action) => {
    ...
    userContext.updateRelationshipLevel(relationship.name, 10)
    ...
    console.log(relationship.name, action.health, action.happiness, action.look, action.relationshipLevel);
