  ...
  const renderJobDetails = (job) => {
    ...
    return (
      <View style={styles.detailsContainer}>
        <Text>
          <Text style={styles.label}>Job:</Text> {job.job}
        </Text>
        <Text>
          <Text style={styles.label}>Years:</Text> {job.years}
        </Text>
        <Text>
          <Text style={styles.label}>Salary:</Text> {job.salary}
        </Text>
      </View>
    );
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <AlertPopup
        ...
        buttonText={occupation?.name ? "Quit Job" : "OK"} // Text changes based on occupation presence
        buttonOnPress={occupation?.name ? quitJob : closeModal} // Function changes based on occupation presence
      />
      <View style={styles.buttonOutterContainer}>
